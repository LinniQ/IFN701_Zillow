...
p11[which.max(p1$logerror),]
p11[which.min(p1$logerror),]

p12 <- subset(mergeid, logerror == "0") 
p13 <- subset(mergeid, logerror > "0" &logerror < "0.15") 
p13[which.max(p1$logerror),]
p13[which.min(p1$logerror),]
...
p1$logerror <- replace(p1$logerror, p1$logerror <= "-0.14", "A")
p1$logerror <- replace(p1$logerror, p1$logerror > "-0.14" & p1$logerror <= "-0.13", "B")
p1$logerror <- replace(p1$logerror, p1$logerror > "-0.13" & p1$logerror <= "-0.12", "C")
p1$logerror <- replace(p1$logerror, p1$logerror > "-0.12" & p1$logerror <= "-0.11", "D")
p1$logerror <- replace(p1$logerror, p1$logerror > "-0.11" & p1$logerror <= "-0.10", "E")
p1$logerror <- replace(p1$logerror, p1$logerror > "-0.10" & p1$logerror <= "-0.09", "F")
p1$logerror <- replace(p1$logerror, p1$logerror > "-0.09" & p1$logerror <= "-0.08", "G")
p1$logerror <- replace(p1$logerror, p1$logerror > "-0.08" & p1$logerror <= "-0.07", "H")
p1$logerror <- replace(p1$logerror, p1$logerror > "-0.07" & p1$logerror <= "-0.06", "I")
p1$logerror <- replace(p1$logerror, p1$logerror > "-0.06" & p1$logerror <= "-0.05", "J")
p1$logerror <- replace(p1$logerror, p1$logerror > "-0.05" & p1$logerror <= "-0.04", "K")
p1$logerror <- replace(p1$logerror, p1$logerror > "-0.04" & p1$logerror <= "-0.03", "L")
p1$logerror <- replace(p1$logerror, p1$logerror > "-0.03" & p1$logerror <= "-0.02", "M")
p1$logerror <- replace(p1$logerror, p1$logerror > "-0.02" & p1$logerror <= "-0.01", "N")
p1$logerror <- replace(p1$logerror, p1$logerror > "-0.01" & p1$logerror <= "0", "O")
p1$logerror <- replace(p1$logerror, p1$logerror > "0" & p1$logerror <= "0.01", "P")
p1$logerror <- replace(p1$logerror, p1$logerror > "0.01" & p1$logerror <= "0.02", "Q")
p1$logerror <- replace(p1$logerror, p1$logerror > "0.02" & p1$logerror <= "0.03", "R")
p1$logerror <- replace(p1$logerror, p1$logerror > "0.03" & p1$logerror <= "0.04", "S")
p1$logerror <- replace(p1$logerror, p1$logerror > "0.04" & p1$logerror <= "0.05", "T")
p1$logerror <- replace(p1$logerror, p1$logerror > "0.05" & p1$logerror <= "0.06", "U")
p1$logerror <- replace(p1$logerror, p1$logerror > "0.06" & p1$logerror <= "0.07", "V")
p1$logerror <- replace(p1$logerror, p1$logerror > "0.07" & p1$logerror <= "0.08", "W")
p1$logerror <- replace(p1$logerror, p1$logerror > "0.08" & p1$logerror <= "0.09", "X")
p1$logerror <- replace(p1$logerror, p1$logerror > "0.09" & p1$logerror <= "0.10", "Y")
p1$logerror <- replace(p1$logerror, p1$logerror > "0.10" & p1$logerror <= "0.11", "Z")
p1$logerror <- replace(p1$logerror, p1$logerror > "0.11" & p1$logerror <= "0.12", "AA")
p1$logerror <- replace(p1$logerror, p1$logerror > "0.12" & p1$logerror <= "0.13", "AB")
p1$logerror <- replace(p1$logerror, p1$logerror > "0.13" & p1$logerror <= "0.14", "AC")
p1$logerror <- replace(p1$logerror, p1$logerror > "0.14" & p1$logerror <= "0.15", "AD")
...
# clean the data, keep numeric data only
```{r}
...
table(predict(tree1, newdata = p1_test),pa_test$logerror)
